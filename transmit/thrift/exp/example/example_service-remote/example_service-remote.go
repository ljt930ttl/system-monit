...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  Example Echo(Example request)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := example.NewExampleServiceClient(thrift.NewTStandardClient(iprot, oprot))
